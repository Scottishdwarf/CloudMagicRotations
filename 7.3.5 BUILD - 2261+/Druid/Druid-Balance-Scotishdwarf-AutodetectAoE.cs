        ...
        public override void Pulse()
        {
            ...
            if (combatRoutine.Type == RotationType.SingleTarget)
            {
				...
				if (WoW.PlayerHasBuff("Bear Form"))
				{
					...
					if (WoW.CanCast("Moonfire") && (!WoW.TargetHasDebuff("Moonfire") || WoW.TargetHasDebuff("Moonfire") && WoW.TargetDebuffTimeRemaining("Moonfire") <= 200))
					{
                ...
                if (WoW.CanCast("HalfMoon") && WoW.IsSpellInRange("Moon") && WoW.PlayerHasBuff("FulminationCharge") && !WoW.CanCast("Starsurge"))
                {
                    WoW.CastSpell("HalfMoon");
                    return;
                }
                if (WoW.CanCast("FullMoon") && WoW.IsSpellInRange("Moon") && WoW.PlayerHasBuff("FulminationCharge") && !WoW.CanCast("Starsurge"))
                {
                    WoW.CastSpell("FullMoon");
                    return;
                }
...
Buff,209407,OnethsOverconfidence
Buff,224706,EmeraldDreamcatcherBuff
Buff,164547,LunarEmp
Buff,164545,SolarEmp
Buff,24858,Moonkin
Buff,194223,CelestialAlignment
Buff,102560,Incarnation
Buff,80353,Timewarp
Buff,2825,Heroism
Buff,774,Rejuvenation
Buff,215632,FulminationCharge
Buff,202737,BlessingOfElune
Buff,202739,BlessingOfAnshe
Buff,157228,OwlkinFrenzy
Buff,191034,StarfallP
Buff,783,Travel Form
Buff,5487,Bear Form
Buff,22842,Frenzied Regeneration
Debuff,164812,Moonfire
Debuff,164815,Sunfire
Debuff,202347,StellarFlare
Debuff,197637,StarfallT
Debuff,192090,ThrashBear
Charge,202767,Moon
Charge,202771,FullMoon
Charge,202768,HalfMoon
Charge,22842,Frenzied Regeneration
Range,8921,Moonfire
Range,93402,Sunfire
Range,194153,LStrike
Range,202767,Moon
Range,78674,Starsurge
Range,190984,SolarW
Range,202347,StellarFlare
Item,133642,KBW
*/
