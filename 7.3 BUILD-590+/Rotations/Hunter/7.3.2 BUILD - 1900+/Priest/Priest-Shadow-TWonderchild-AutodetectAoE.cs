...
namespace CloudMagic.Rotation
{
    public class TWonderchildSP2 : CombatRoutine
    {
        ...
        public override void Initialize()
        {
            ...
            Log.Write("Welcome to TWonderchild's Shadow Priest", Color.Black);
            Log.DrawHorizontalLine();
            Log.Write("Please use the following Talents: 1211111", Color.Black);
            Log.Write("Surrender to Madness is not supported.", Color.Black);
            Log.Write("Check the ToDo-List before reporting bugs/requesting features", Color.Black);
            Log.Write("Cooldown Hotkey: F7", Color.Black);
