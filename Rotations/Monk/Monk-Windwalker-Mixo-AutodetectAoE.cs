...
/* 	Mixo's WindWalker Rotation v2.5
	...
	Feedback is appreciated in the Monk section on CloudMagic's Discord. Tag it with @[EU]Mixo :)
...
namespace CloudMagic.Rotation
{
    public class WindwalkerMonk : CombatRoutine
    {
        ...
        public override void Initialize()
        {
            ...
            Log.Write("", Color.SpringGreen);
            Log.Write("Feedback is appreciated in the Monk section on CloudMagic's Discord.", Color.SpringGreen);
