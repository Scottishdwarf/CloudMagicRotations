...
{
    public class HunterBM : CombatRoutine
    {
        ...
        public override void Pulse()
        {
            if (combatRoutine.Type == RotationType.SingleTarget)  // Do Single Target Stuff here
            {
                ...
                {	
					...
					if (WoW.CanCast("Titan's Thunder") && !WoW.IsSpellOnCooldown("Titan's Thunder") && WoW.PlayerHasBuff("Bestial Wrath") && WoW.PlayerBuffTimeRemaining("Bestial Wrath") >= 700)
					{
                        WoW.CastSpell("Titan's Thunder");
						return;
					}
                    if (WoW.CanCast("A Murder of Crows")  && !WoW.IsSpellOnCooldown("A Murder of Crows") && Crow && WoW.IsSpellInRange("A Murder of Crows") && WoW.Focus >= 30 && WoW.SpellCooldownTimeRemaining("Bestial Wrath") >= 1100)
                    {
					...
					if (WoW.CanCast("Bestial Wrath") && WoW.Focus >= 115 && WoW.IsSpellInRange("Cobra Shot") && !WoW.PlayerHasBuff("Turtle") && !WoW.IsSpellOnCooldown("Bestial Wrath") && WoW.IsSpellOnCooldown("Kill Command"))
                    {
                        WoW.CastSpell("Bestial Wrath");
                        return;
                    }
					if (WoW.CanCast("Bestial Wrath") && WoW.Focus >= 90 && WoW.IsSpellInRange("Cobra Shot") && !WoW.PlayerHasBuff("Turtle") && !WoW.IsSpellOnCooldown("Bestial Wrath") && !WoW.IsSpellOnCooldown("Kill Command"))
                    {
                        WoW.CastSpell("Bestial Wrath");
                        return;
                    }
					if (WoW.CanCast("Bestial Wrath") && WoW.Focus >= 85 && WoW.IsSpellInRange("Cobra Shot") && !WoW.PlayerHasBuff("Turtle") && !WoW.IsSpellOnCooldown("Bestial Wrath") && !WoW.IsSpellOnCooldown("Dire Frenzy"))
                    {
                        WoW.CastSpell("Bestial Wrath");
                        return;
                    }
					...
					if (WoW.CanCast("Dire Frenzy") && WoW.IsSpellInRange("Kill Command") && !WoW.IsSpellOnCooldown("Dire Frenzy") && WoW.PetHasBuff("Dire Frenzy") && (WoW.SpellCooldownTimeRemaining("Bestial Wrath") >= 390 && WoW.PetBuffTimeRemaining("Dire Frenzy") <= 160 || WoW.PlayerSpellCharges("Dire Frenzy") >=2))
                    {
                        WoW.CastSpell("Titan's Thunder");
					...
					if (WoW.CanCast("Kill Command") && WoW.Focus >= 80 && WoW.IsSpellInRange("Kill Command"))
                    {
                        WoW.CastSpell("Kill Command");
                        return;
                    }
                    if (WoW.CanCast("Dire Frenzy") && WoW.IsSpellInRange("Kill Command") && !WoW.IsSpellOnCooldown("Dire Frenzy") && (WoW.SpellCooldownTimeRemaining("Bestial Wrath") >= 390 && WoW.PetBuffTimeRemaining("Dire Frenzy") <= 160 || WoW.PlayerSpellCharges("Dire Frenzy") >=2))
                    {
                        WoW.CastSpell("Titan's Thunder");
						WoW.CastSpell("Dire Frenzy");
					...
					if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 46) && WoW.IsSpellInRange("Cobra Shot") && WoW.PlayerHasBuff("Bestial Wrath") && WoW.IsSpellOnCooldown("Kill Command") && WoW.SpellCooldownTimeRemaining("Kill Command") > 140)
                    {
                        WoW.CastSpell("Cobra Shot");
                        return;
                    }		
					if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 28) && WoW.IsSpellInRange("Cobra Shot") && WoW.PlayerHasBuff("Bestial Wrath") && WoW.PlayerBuffTimeRemaining("Bestial Wrath") <= 200 && WoW.IsSpellOnCooldown("Kill Command") && WoW.SpellCooldownTimeRemaining("Kill Command") > 140)
                    {
                        WoW.CastSpell("Cobra Shot");
                        return;
                    }					
					if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 90) && WoW.IsSpellInRange("Cobra Shot") && WoW.IsSpellOnCooldown("Bestial Wrath") && WoW.SpellCooldownTimeRemaining("Bestial Wrath") >= 140 && WoW.SpellCooldownTimeRemaining("Kill Command") >= 140)
                    {
                        WoW.CastSpell("Cobra Shot");
                        return;
                    }
            ...
            if (combatRoutine.Type == RotationType.AOE)
            {
                ...
                if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat)
                {
                    ...
                    if (WoW.CanCast("Multi-Shot") && (WoW.Focus >= 34) && WoW.PlayerHasBuff("Bestial Wrath") && WoW.PetBuffTimeRemaining("Beast Cleave") <= 100 && WoW.IsSpellInRange("Multi-Shot"))
                    {
                        WoW.CastSpell("Multi-Shot");                        
                        return;
                    }
                    if (WoW.CanCast("Multi-Shot") && (WoW.Focus >= 40) && WoW.PetBuffTimeRemaining("Beast Cleave") <= 100 && WoW.IsSpellInRange("Multi-Shot") && !WoW.CanCast("Bestial Wrath"))
                    {
                        WoW.CastSpell("Multi-Shot");                        
                        return;
                    }
					...
					if (WoW.CanCast("Aspect of the Wild") && !WoW.IsSpellOnCooldown("Aspect of the Wild")  && WoW.PlayerHasBuff("Bestial Wrath") && WoW.PlayerBuffTimeRemaining("Bestial Wrath") >= 10000 && (dpscooldowns || WoW.PlayerHasBuff("Bloodlust") || WoW.PlayerHasBuff("Ancient Hysteria") || WoW.PlayerHasBuff("Netherwinds") || WoW.PlayerHasBuff("Drums") || WoW.PlayerHasBuff("Heroism") || WoW.PlayerHasBuff("Time Warp") )) 
                    {
                        WoW.CastSpell("Aspect of the Wild");
						WoW.CastSpell("Blood Fury");
						return;
                    }
                    if (WoW.CanCast("Dire Frenzy") && WoW.IsSpellInRange("Kill Command") && !WoW.IsSpellOnCooldown("Dire Frenzy") && (WoW.SpellCooldownTimeRemaining("Bestial Wrath") >= 390 && WoW.PetBuffTimeRemaining("Dire Frenzy") <= 300 || WoW.PlayerSpellCharges("Dire Frenzy") >=2))
                    {
                        WoW.CastSpell("Titan's Thunder");
						WoW.CastSpell("Dire Frenzy");
                    ...
                    if (WoW.CanCast("Kill Command") && WoW.Focus >= 55 && WoW.IsSpellInRange("Kill Command") && WoW.PetHasBuff("Beast Cleave") && WoW.PetBuffTimeRemaining("Beast Cleave") >= 130 && !(DetectKeyPress.GetKeyState(0x5A) < 0) && !FourTarget  && WoW.SpellCooldownTimeRemaining("Bestial Wrath") >= 150)
                    {
                        WoW.CastSpell("Kill Command");
                        return;
                    }
                    ...
                    if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 40) && WoW.IsSpellInRange("Cobra Shot") && WoW.PetHasBuff("Beast Cleave") && WoW.PetBuffTimeRemaining("Beast Cleave") >= 130 && WoW.PlayerHasBuff("Bestial Wrath") && WoW.SpellCooldownTimeRemaining("Kill Command") >= 250)
                    {
                        WoW.CastSpell("Cobra Shot");
                        return;
                    }
					if (WoW.CanCast("Cobra Shot") && (WoW.Focus >= 91) && WoW.IsSpellInRange("Cobra Shot") && WoW.PetHasBuff("Beast Cleave") && WoW.PetBuffTimeRemaining("Beast Cleave") >= 130 && WoW.SpellCooldownTimeRemaining("Kill Command") >= 150)
                    {
                        WoW.CastSpell("Cobra Shot");
                        return;
                    }
            ...
            if (combatRoutine.Type == RotationType.SingleTargetCleave)
            {
                ...
                if (WoW.HasTarget && WoW.TargetIsEnemy && WoW.IsInCombat)
                {
					...
					if (WoW.CanCast("A Murder of Crows") && !WoW.IsSpellOnCooldown("A Murder of Crows") && Crow && WoW.IsSpellInRange("A Murder of Crows") && WoW.PetHasBuff("Beast Cleave") && WoW.PetBuffTimeRemaining("Beast Cleave") >= 130 && WoW.Focus >= 55 && !(DetectKeyPress.GetKeyState(0x5A) < 0) && !(WoW.SpellCooldownTimeRemaining("Bestial Wrath") <= 2300))
                    {
                        WoW.CastSpell("A Murder of Crows");
                        return;
                    }
